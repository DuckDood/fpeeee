...
obj/constraints.c.o: engine/src/constraints.c 
ifeq (${OSMODE}, l)
	${CC} engine/src/constraints.c -c -o obj/constraints.c.o -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g
else
	${CC} engine/src/constraints.c -c -o obj/constraints.c.o -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g
endif
