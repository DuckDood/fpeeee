all: obj/ build/ obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/fluid.c.o build/fluid obj/cutcloth.c.o build/cutcloth obj/parachute.c.o build/parachute obj/fluid_3d.c.o build/fluid_3d obj/cloth.c.o build/cloth 
OSMODE := l
