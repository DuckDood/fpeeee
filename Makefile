all: obj/ build/ obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/fluid.c.o build/fluid obj/cutcloth.c.o build/cutcloth obj/parachute.c.o build/parachute obj/dynamic_wall_parachute.c.o build/dynamic_wall_parachute obj/fluid_3d.c.o build/fluid_3d obj/cloth.c.o build/cloth obj/2d_3d_scene.c.o build/2d_3d_scene 
OSMODE := l
...
build/cutcloth: obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/cutcloth.c.o 
ifeq (${OSMODE}, l)
	${CC} obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/cutcloth.c.o -o build/cutcloth -lm -lSDL3 -g
else
	${CC} obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/cutcloth.c.o -o build/cutcloth -lm -lSDL3 -g
endif
...
build/parachute: obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/parachute.c.o 
ifeq (${OSMODE}, l)
	${CC} obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/parachute.c.o -o build/parachute -lm -lSDL3 -g
else
	${CC} obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/parachute.c.o -o build/parachute -lm -lSDL3 -g
endif


obj/dynamic_wall_parachute.c.o: demos/dynamic_wall_parachute.c 
ifeq (${OSMODE}, l)
	${CC} demos/dynamic_wall_parachute.c -c -o obj/dynamic_wall_parachute.c.o -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/
else
	${CC} demos/dynamic_wall_parachute.c -c -o obj/dynamic_wall_parachute.c.o -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/
endif


build/dynamic_wall_parachute: obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/dynamic_wall_parachute.c.o 
ifeq (${OSMODE}, l)
	${CC} obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/dynamic_wall_parachute.c.o -o build/dynamic_wall_parachute -lm -lSDL3 -g
else
	${CC} obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/dynamic_wall_parachute.c.o -o build/dynamic_wall_parachute -lm -lSDL3 -g
endif
...
build/cloth: obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/cloth.c.o 
ifeq (${OSMODE}, l)
	${CC} obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/cloth.c.o -o build/cloth -lm -lSDL3 -g
else
	${CC} obj/types.c.o obj/physics.c.o obj/shape_generators.c.o obj/spatial.c.o obj/helpers.c.o obj/matrix.c.o obj/cloth.c.o -o build/cloth -lm -lSDL3 -g
endif
...
ifeq (${OSMODE}, l)
	clang demos/cutcloth.c  -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/ -MJ emmgtemp/7.json -fsyntax-only
else
	clang demos/cutcloth.c  -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/ -MJ emmgtemp/7.json -fsyntax-only
endif
ifeq (${OSMODE}, l)
	clang demos/parachute.c  -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/ -MJ emmgtemp/8.json -fsyntax-only
else
	clang demos/parachute.c  -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/ -MJ emmgtemp/8.json -fsyntax-only
endif
ifeq (${OSMODE}, l)
	clang demos/dynamic_wall_parachute.c  -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/ -MJ emmgtemp/9.json -fsyntax-only
else
	clang demos/dynamic_wall_parachute.c  -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/ -MJ emmgtemp/9.json -fsyntax-only
endif
ifeq (${OSMODE}, l)
...
ifeq (${OSMODE}, l)
	clang demos/2d_3d_scene.c  -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/ -MJ emmgtemp/12.json -fsyntax-only
else
	clang demos/2d_3d_scene.c  -Iengine/include/ -O3 -std=c23 -Wall -Wextra -Wpedantic -Werror -march=native -g -Idemos/helpers/ -MJ emmgtemp/12.json -fsyntax-only
endif
